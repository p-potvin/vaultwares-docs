...
- If scheduled task, use conhost.exe with arguments: "--headless powershell.exe -NoProfile -WindowStyle Hidden -NonInteractive -ExecutionPolicy Bypass -File <your script>"
Do not:
