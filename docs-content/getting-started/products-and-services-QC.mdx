...
### Comment choisir (3 profils)

| Ton profil | Commence par | Pourquoi |
|---|---|---|
| “Je veux juste comprendre” | **Vault Flows** | c’est l’écran le plus simple |
| “Je veux automatiser pour vrai” | **Vault Pipelines** | c’est le moteur des recettes |
| “Je veux tout voir au même endroit” | **Vault Central** | tableau de bord dans le navigateur |
...
| **Vault TV** | Client mince de streaming pour TV | Fire TV / Android TV | “La lecture sur grand écran; la recherche de sources reste côté serveur.” |
...
<Tip>
  Si tu lis juste UNE chose : retiens “Flows = l’écran, Pipelines = le moteur”.
</Tip>
...
## Mini-glossaire (même si tu connais rien)

| Mot | Sens |
|---|---|
| **Local** | ça tourne sur tes machines |
| **Recette / workflow** | une suite d’étapes que tu peux relancer |
| **Réseau privé** | un tunnel sécurisé entre tes machines |
