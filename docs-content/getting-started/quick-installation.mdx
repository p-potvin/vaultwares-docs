...
<Check>
  You will need %USERPROFILE% or root privileges to install VaultWares products.
</Check>
...
<Steps>
  ...
  <Step title="Create admin account">
    Enter your %USERPROFILE% email and create a strong password (minimum 12 characters).
  </Step>
