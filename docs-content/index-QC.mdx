...
<CardGroup cols={2}>
  ...
  <Card title="Outil en ligne de commande (vw)" icon="terminal" href="/operations/command-line-tool">
    Point d'entrée de centralisation et routeur de scripts d'automatisation PowerShell.
  </Card>
</CardGroup>
