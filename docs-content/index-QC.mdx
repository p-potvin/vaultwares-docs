...
<CardGroup cols={2}>
  ...
  <Card title="Recettes du jour (diagrams)" icon="diagram-project" href="/getting-started/daily-flows">
    Exemples concrets de workflows (hobbies/métiers) en diagrammes.
  </Card>
</CardGroup>
